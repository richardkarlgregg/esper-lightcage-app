...
<body <?php body_class('bg-gray-900 text-white min-h-screen'); ?>>
<?php wp_body_open(); ?>

<!-- Menu Bar -->
<div class="menu-bar bg-gray-800 text-white px-4 py-1 flex items-center space-x-4">
    <div class="menu-item relative">
        <button class="hover:bg-gray-700 px-3 py-1 rounded">File</button>
        <div class="menu-dropdown bg-gray-800 rounded shadow-lg py-1">
...
<div id="jobModal" class="modal-overlay">
    <div class="modal bg-gray-800 rounded-lg shadow-xl">
        ...
        <div class="p-4">
            <div class="mb-4">
                <input type="text" id="jobSearch" placeholder="Search jobs..." class="w-full bg-gray-700 text-white px-3 py-2 rounded border border-gray-600 focus:border-yellow-300 focus:outline-none">
            </div>
